...
class PredictionDiabetesRecord extends FirestoreRecord {
  PredictionDiabetesRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('prediction_diabetes');

  static Stream<PredictionDiabetesRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => PredictionDiabetesRecord.fromSnapshot(s));

  static Future<PredictionDiabetesRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => PredictionDiabetesRecord.fromSnapshot(s));

  static PredictionDiabetesRecord fromSnapshot(DocumentSnapshot snapshot) =>
      PredictionDiabetesRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static PredictionDiabetesRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      PredictionDiabetesRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'PredictionDiabetesRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is PredictionDiabetesRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createPredictionDiabetesRecordData({
  double? age,
...
class PredictionDiabetesRecordDocumentEquality
    implements Equality<PredictionDiabetesRecord> {
  const PredictionDiabetesRecordDocumentEquality();

  @override
  bool equals(PredictionDiabetesRecord? e1, PredictionDiabetesRecord? e2) {
  ...
  @override
  int hash(PredictionDiabetesRecord? e) => const ListEquality().hash([
        e?.age,
        e?.anyHealthcare,
        e?.bmi,
        e?.cholCheck,
  ...
  @override
  bool isValidKey(Object? o) => o is PredictionDiabetesRecord;
}
