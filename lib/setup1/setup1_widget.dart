                  ...
                  Row(
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'z17icq78' /* Healthcare Analysis System */,
                          ),
                          textAlign: TextAlign.center,
                          style:
                                            ...
                                            Expanded(
                                              child:
                                                ...
                                                options: [
                                                  ...
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'bo5qbprm' /* Human Resource */,
                                                  ),
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'ercqkq9z' /* Sales & Marketing */,
                                                  ),
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '1g5ea19b' /* Finance */,
                                                                ...
                                                                children: [
                                                                  AutoSizeText(
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'rcoe4lge' /* You can still edit the informa... */,
                                                                    ),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
