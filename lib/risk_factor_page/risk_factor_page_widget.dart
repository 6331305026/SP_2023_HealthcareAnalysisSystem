...
import 'risk_factor_page_model.dart';
export 'risk_factor_page_model.dart';

class RiskFactorPageWidget extends StatefulWidget {
  const RiskFactorPageWidget({
    Key? key,
    this.healthref,
  }) : super(key: key);
  ...
  @override
  _RiskFactorPageWidgetState createState() => _RiskFactorPageWidgetState();
}

class _RiskFactorPageWidgetState extends State<RiskFactorPageWidget>
    with TickerProviderStateMixin {
  late RiskFactorPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RiskFactorPageModel());
    ...
    return StreamBuilder<List<PredictionExpenseRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PredictionExpenseRecord>
            riskFactorPagePredictionExpenseRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final riskFactorPagePredictionExpenseRecord =
            riskFactorPagePredictionExpenseRecordList.isNotEmpty
                ? riskFactorPagePredictionExpenseRecordList.first
                : null;
                              ...
                              Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '1l5sr9ju' /* Healthcare Analysis System */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'izzmu88p' /* Update Health Information */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'aj3tuqdd' /* Health Recorded Lists */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '8x9a3mmn' /* Sorry, this page is currently ... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
