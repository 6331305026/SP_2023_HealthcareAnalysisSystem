...
import 'health_recorded_page_model.dart';
export 'health_recorded_page_model.dart';

class HealthRecordedPageWidget extends StatefulWidget {
  const HealthRecordedPageWidget({Key? key}) : super(key: key);

  @override
  _HealthRecordedPageWidgetState createState() =>
      _HealthRecordedPageWidgetState();
}

class _HealthRecordedPageWidgetState extends State<HealthRecordedPageWidget>
    with TickerProviderStateMixin {
  late HealthRecordedPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HealthRecordedPageModel());
                          ...
                          Row(
                            ...
                            children: [
                              InkWell(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '20jba4rm' /* Healthcare Analysis System */,
                                  ),
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '5d6d2hzb' /* Update Health Information */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '5z0kaul2' /* Health Recorded Lists */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                        ...
                        children: [
                          ...
                          StreamBuilder<List<PersonRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<PersonRecord> column2PersonRecordList =
                                  snapshot.data!;
                              // Return an empty Container when the item does not exist.
                              if (snapshot.data!.isEmpty) {
                                return Container();
                              }
                              final column2PersonRecord =
                                  column2PersonRecordList.isNotEmpty
                                      ? column2PersonRecordList.first
                                      : null;
                              return Column(
                                mainAxisSize: MainAxisSize.min,
                                mainAxisAlignment: MainAxisAlignment.start,
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return Column(
                                        ...
                                        children: List.generate(
                                            columnHealthRecordList.length,
                                            (columnIndex) {
                                          final columnHealthRecord =
                                              columnHealthRecordList[
                                                  columnIndex];
                                          return Padding(
                                            padding:
